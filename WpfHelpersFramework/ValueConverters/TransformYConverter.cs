...
namespace ValueConverters
{
	...
	/// </summary>
	public class TransformYConverter :IMultiValueConverter
	{
		/// <summary>
		/// Translates the Y coordiante, from values[2], into the coordinate system of the control in values[0],
		...
		/// values[2] = Y coordinate to transform from the source container into the target container.
		/// </param>
		/// <param name="targetType">Not used.</param>
		/// <param name="parameter">Not used.</param>
		/// <param name="culture">Not used.</param>
		/// <returns>Y coordinate, in the target container (values[1]).</returns>
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			...
			Point point = source.TranslatePoint(new Point(0, top.Value), relativeTo);
