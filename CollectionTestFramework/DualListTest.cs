...
namespace CollectionTest
{
	...
	public class DualListTTest
	{
		...
		public void Insert_UsingDefaultObjectFactory()
		{
			...
			DualList<int, object> dualCollection = new DualList<int, object>(primaryCollection, secondaryCollection);
		...
		public void Insert_UsingCustomObjectFactory()
		{
			...
			DualList<int, bool> dualCollection = new DualList<int, bool>(primaryCollection, secondaryCollection);
		...
		public void InsertMultiple_UsingCustomObjectFactory()
		{
			...
			DualList<int, int> dualCollection = new DualList<int, int>(primaryCollection, secondaryCollection);
		...
		public void EnumerateDualCollection()
		{
			...
			foreach(DualItem<int, int> currentValue in dualCollection)
			{
				Assert.IsTrue((int) (currentValue.Secondary) == (int) (currentValue.Primary)*2);
				iterations++;
			}
